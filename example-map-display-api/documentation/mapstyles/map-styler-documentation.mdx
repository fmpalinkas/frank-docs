...
<Blockquote type="announcement" hasIcon>
  Map Styler has been deprecated. Please use the <a href="https://developer.tomtom.com/map-maker" target="_blank">TomTom Map Maker</a> instead.
...
<Button
  ...
  href="https://developer.tomtom.com/maps-api/map-styler"
  target="_blank"
  icon="arrow"
/>
<br />
...
There are multiple entities you can choose from depending on the Layer type. For further information see  [TomTom&#39;s Vector Tiles V2 documentation](/map-display-api/documentation/vector/tile-v2) , which is the default vector tile service used in the Customization Tool. If you have a map style based on the Vector Tiles V1 service, see  [TomTom&#39;s Vector Tiles V1 documentation](/map-display-api/documentation/vector/tile).
