...
The TomTom Orbis Maps Map Display API Vector Tiles web service suite offers the following services:

<DocsArticles
  articles={[
    {
      title: 'Vector Tiles',
      body: 'The TomTom Orbis Maps Vector Tiles endpoint serves data on zoom levels ranging from 0 to 22.',
      button: {
        label: 'Documentation',
        href: './tile',
      },
    ...
    {
      title: 'Tile Content',
      body: 'The TomTom Orbis Maps Vector Tiles Content document contains map features (points, lines, road shapes, water polygons, building footprints, etc.) that can be used to visualize map data.',
      button: {
        label: 'Documentation',
        href: './content',
      },
