...
![Vector tile example](resource/orbis-main-example.png)
...
Maps are displayed using  [tiles](./zoom-levels-and-tile-grid). The Map Display API distributes tiles in two formats. Find out more about these formats in [Which map style is right for you](https://developer.tomtom.com/blog/decoded/raster-versus-vector-which-map-style-right-you).

- **Vector tiles.** This means the Map Display API Vector Tile endpoint returns **map data** to your client instead of **map images**.
  - You can style and customize vector tiles using [Assets API](../../../assets-api/documentation/tomtom-orbis-maps/product-information/introduction).
...
Overlaying traffic information on the map is easy. The  [Traffic API documentation](/traffic-api/documentation/tomtom-orbis-maps/introduction)  explains how to do this.
...
Various styles are available for the display of map data. They can be customized to suit specific needs. The [Assets API documentation](https://developer.tomtom.com/assets-api/documentation/tomtom-orbis-maps/product-information/introduction) explains how to do this.
