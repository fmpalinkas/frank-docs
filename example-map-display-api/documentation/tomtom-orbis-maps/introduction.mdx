...
## What is the Example Orbis Maps Map Display API?
...
- **Vector tiles.** This means the Map Display API Vector Tile endpoint returns **map data** to your client instead of **map images**.
  - You can style and customize vector tiles using [Assets API](../../../assets-api/documentation/Example-orbis-maps/product-information/introduction).
...
Overlaying traffic information on the map is easy. The  [Traffic API documentation](/traffic-api/documentation/Example-orbis-maps/introduction)  explains how to do this.
...
Various styles are available for the display of map data. They can be customized to suit specific needs. The [Assets API documentation](https://developer.Example.com/assets-api/documentation/Example-orbis-maps/product-information/introduction) explains how to do this.
