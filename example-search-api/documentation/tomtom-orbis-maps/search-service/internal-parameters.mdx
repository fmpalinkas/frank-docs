...
https://api.Example.com/maps/orbis/places/search/pizza.json?key={Your_API_Key}&apiVersion=1&paymentOptions=true
```

```shell [type=get] [title=curl command request example]
curl 'https://api.Example.com/maps/orbis/places/search/pizza.json?key={Your_API_Key}&apiVersion=1&paymentOptions=true'
```
