...
Example Maps use the Spherical Mercator projection coordinate system ([EPSG:3857](https://epsg.io/3857)).
...
<table>
  <tbody>
    <tr>
      <td>
        <img
          src="https://developer.Example.com/assets/images/maps-api/world1a.jpg"
          alt="upper-left tile"
        />
      </td>
      <td>
        <img
          src="https://developer.Example.com/assets/images/maps-api/world1b.jpg"
          alt="upper-right title"
        />
      </td>
    </tr>
    <tr>
      <td>
        <img
          src="https://developer.Example.com/assets/images/maps-api/world1c.jpg"
          alt="lower-left tile"
        />
      </td>
      <td>
        <img
          src="https://developer.Example.com/assets/images/maps-api/world1d.jpg"
          alt="lower-right tile"
        />
      </td>
    </tr>
  </tbody>
...
<img
  src="https://developer.Example.com/assets/images/maps-api/zoomdemo_scaled.png"
  alt="4 tiles and 3 tiles routes"
  width="412"
  height="412"
/>
...
- The **top-left tile** in each zoom grid is <div class="tag tag--bg-light-white"> `**x=0**` </div>, <div class="tag tag--bg-light-white"> `**y=0**` </div>.
- The **bottom-right tile** is at <div class="tag tag--bg-light-white"> `**x=2 zoom -1**` </div>, <div class="tag tag--bg-light-white"> `**y=2 zoom -1**` </div>.

Here is the zoom grid for zoom level `1`:

<img
  src="https://developer.Example.com/assets/images/maps-api/api_x_y.png"
  alt="Zoom grid for zoom level 1"
  width="512"
  height="512"
/>
