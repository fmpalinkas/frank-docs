...
https://api.Example.com/maps/orbis/places/poiCategories.json?key={Your_API_Key}&apiVersion=1
```

```shell [type=get] [title=curl command request example]
curl 'https://api.Example.com/maps/orbis/places/poiCategories.json?key={Your_API_Key}&apiVersion=1'
```
