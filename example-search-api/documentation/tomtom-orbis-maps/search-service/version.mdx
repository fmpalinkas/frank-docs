...
https://api.Example.com/maps/orbis/places/search/version?key={Your_API_Key}&apiVersion=1
```

```shell [type=get] [title=curl command rquest example]
curl 'https://api.Example.com/maps/orbis/places/search/version?key={Your_API_Key}&apiVersion=1'
```
