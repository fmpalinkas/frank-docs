...
<Blockquote type="announcement" hasIcon>
    ...
    <p>
        ...
        [Public Preview - what is it?](https://developer.tomtom.com/public-preview)
...
https://api.tomtom.com/map/1/style/metadata.json?key={Your_API_Key}

https://api.tomtom.com/map/1/style/22.2.1-9/2/metadata.json?key={Your_API_Key}

https://api.tomtom.com/map/1/style/22.*/2/metadata.json?key={Your_API_Key}

https://api.tomtom.com/map/1/sprite/22.2.1-9/2/metadata.json?key={Your_API_Key}

https://api.tomtom.com/map/1/glyph/22.2.1-9/metadata.json?key={Your_API_Key}
```
...
https://api.tomtom.com/map/1/style/22.*/2/basic_street-light.json?key={Your_API_Key}

https://api.tomtom.com/map/1/style/22.2.1-9/2/basic_street-light.json?key={Your_API_Key}

https://api.tomtom.com/map/1/sprite/22.2.1-9/2/basic_street-light/sprite.png?key={Your_API_Key}
```
...
```shell [type=get] [title=Example request URL]
https://api.tomtom.com/style/1/sprite/22.2.1-9/sprite.png?key={Your_API_Key}&map=2/basic_street-light&traffic_incidents=2/incidents_light&traffic_flow=2/flow_relative-light&poi=2/poi_light

https://api.tomtom.com/style/1/sprite/22.2.1-9/sprite@2x.json?key={Your_API_Key}&map=2/basic_street-light&traffic_incidents=2/incidents_light

https://api.tomtom.com/style/1/sprite/22.2.1-9/sprite@2x.png?key={Your_API_Key}&traffic_incidents=2/incidents_light&traffic_flow=2/flow_relative-light

https://api.tomtom.com/style/1/sprite/24.2.0-3/sprite@2x.png?key={Your_API_Key}&map=2/basic_street-light&hillshade=2/hillshade_dem
```
