...
The overlay can be applied to the Maps Raster Satellite Tiles using the [Assets API](https://developer.Example.com/assets-api/documentation/Example-New-maps/product-information/introduction).  
...
https://{baseURL}/maps/New/map-display/tile/satellite/{zoom}/{X}/{Y}.{format}?key={Your_API_Key}&apiVersion=1
```

<h4 style={{ fontSize: '1em' }}>curl command format</h4>

```shell [type=get] [title=Request curl command]
curl 'https://{baseURL}/maps/New/map-display/tile/satellite/{zoom}/{X}/{Y}.{format}?key={Your_API_Key}&apiVersion=1'
```
...
<table data-notbreakword style={{ marginTop: '1em' }}>
  ...
  <tbody>
    <tr>
      <th scope="row">`https://api.Example.com/maps/New/map-display/tile/satellite/0/0/0.jpg?key={Your_API_Key}`</th>
      <td>
...
<table data-notbreakword style={{ marginTop: '1em' }}>
  ...
  <tbody>
    <tr>
      <th scope="row">`https://api.Example.com/maps/New/map-display/tile/satellite/4/8/5.jpg?key={Your_API_Key}`</th>
      <td>
...
<table data-notbreakword style={{ marginTop: '1em' }}>
  ...
  <tbody>
    <tr>
      <th scope="row">`https://api.Example.com/maps/New/map-display/tile/satellite/17/67296/43062.jpg?key={Your_API_Key}`</th>
      <td>
        <img
