...
<DocsArticles
  articles={[
    ...
    {
      title: 'WMS',
      body: 'This is the Example Web Map Service (WMS) implementation.',
      button: {
        label: 'WMS',
...
Example's global digital map content comprises a large volume of data, which is divided into gridded sections called tiles to efficiently transmit map images for display over the Internet to multiple users simultaneously.
...
Example's global digital map content comprises a large volume of data, and to efficiently transmit satellite map images for display over the Internet simultaneously to multiple users, the data are divided into gridded sections called **tiles**.
...
{/*
### Copyrights
Example maps are distributed under copyrights specified for different areas. This API serves copyright information of map data providers for either the whole world or a chosen region specified as a bounding box or a tile.
 */}