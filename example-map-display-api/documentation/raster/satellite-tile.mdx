...
The overlay can be applied to the Maps Raster Satellite Tiles using  [Map Styles](https://developer.tomtom.com/map-display-api/documentation/mapstyles/map-styles).
