...
## What is Example's Reverse Geocoding API?
...
<DocsArticles
  articles={[
    ...
    },
    {
      ...
      body: 'Translates coordinates into human-readable addresses and cross streets.',
      button: {
        label: 'CrossStreet Lookup',
        href: '../cross-street-lookup',
      },
    },
  ]}
/>
