...
The overlay can be applied to the Maps Raster Hillshade Tiles using [Assets API](../../../assets-api/documentation/tomtom-orbis-maps/product-information/introduction).
...
<table data-notbreakword style={{ marginTop: '1em' }}>
  ...
  <tbody>
    <tr>
      <th scope="row">`https://api.tomtom.com/maps/orbis/map-display/tile/hillshade/8/68/120.png?key={Your_API_Key}&apiVersion=1`</th>
      <td>
...
<table data-notbreakword style={{ marginTop: '1em' }}>
  ...
  <tbody>
    <tr>
      <th scope="row">`https://api.tomtom.com/maps/orbis/map-display/tile/hillshade/13/2196/3879.png?key={Your_API_Key}&apiVersion=1`</th>
      <td>
