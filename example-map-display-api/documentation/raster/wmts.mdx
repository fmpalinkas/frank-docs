...
<Capabilities xmlns="http&#058;//www.opengis.net/wmts/1.0" xmlns&#058;ows="http&#058;//www.opengis.net/ows/1.1" xmlns&#058;xlink="http&#058;//www.w3.org/1999/xlink" xmlns&#058;xsi="http&#058;//www.w3.org/2001/XMLSchema-instance" xmlns&#058;gml="http&#058;//www.opengis.net/gml" xsi&#058;schemaLocation="http&#058;//www.opengis.net/wmts/1.0 http&#058;//schemas.opengis.net/wmts/1.0/wmtsGetCapabilities_response.xsd"version="1.0.0">
  ...
  <ows&#058;ServiceProvider>
    ...
    <ows&#058;ProviderSite xlink&#058;href="https&#058;//www.tomtom.com"/>
    <ows&#058;ServiceContact>
  ...
  <Contents>
    <!-- Basic Map -->
    <Layer>
      <ows&#058;Title>TomTom Map &mdash; Standard</ows&#058;Title>
      ...
      <ResourceURL format="image/png" template="https&#058;//a.api.tomtom.com/{Style}/{TileMatrix}/{TileCol}/{TileRow}.png?key=apiKey" resourceType="tile"/>
      <ResourceURL format="image/png" template="https&#058;//b.api.tomtom.com/{Style}/{TileMatrix}/{TileCol}/{TileRow}.png?key=apiKey" resourceType="tile"/>
      <ResourceURL format="image/png" template="https&#058;//c.api.tomtom.com/{Style}/{TileMatrix}/{TileCol}/{TileRow}.png?key=apiKey" resourceType="tile"/>
      <ResourceURL format="image/png" template="https&#058;//d.api.tomtom.com/{Style}/{TileMatrix}/{TileCol}/{TileRow}.png?key=apiKey" resourceType="tile"/>
    </Layer>
    <Layer>
  ...
  <ServiceMetadataURL xlink:href="https&#058;//api.tomtom.com/map/1/wmts/apiKey/1.0.0/GetCapabilities.xml"/>
</Capabilities>
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         **Internal Server Error** : There is a problem with the TomTom WMTS
        service.
      </td>
    </tr>
  </tbody>
