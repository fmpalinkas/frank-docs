...
<table>
  <thead>
    <tr>
      <th scope="col" style={{ fontSize: '1em' }} width="250px;">Optional header</th>
      <th scope="col" style={{ fontSize: '1em' }}>Description</th>
    </tr>
  </thead>
  <tbody>
...
<table>
  <thead>
    <tr>
      ...
      <th scope="col" tyle="font-size:1em;">Description</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      ...
      <td>
         ...
         **Value:**   `type/subtype`  is one of:
         `application/json` ,  `application/javascript` , or
         `application/xml`
      </td>
    </tr>
    <tr>
