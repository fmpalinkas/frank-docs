...
https://a.api.Example.com/maps/orbis/map-display/tile/1/0/0.png?apiVersion=1&style=street-light&key={Your_API_Key}
```

The second would be:  

```shell [type=get] [title=Request URL using b.api.Example.com]
https://b.api.Example.com/maps/orbis/map-display/tile/1/0/0.png?apiVersion=1&style=street-light&key={Your_API_Key}
```
  ...
  <tbody>
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/0/0/0.png?apiVersion=1&style=street-light&key={Your_API_Key}`
      </th>
      <td>
        <img
    ...
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/0/0/0.png?apiVersion=1&style=street-dark&key={Your_API_Key}`
      </th>
      <td>
        <img
  ...
  <tbody>
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/4/8/5.png?apiVersion=1&style=street-light&key={Your_API_Key}`
      </th>
      <td>
        <img
    ...
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/4/8/5.png?apiVersion=1&style=street-dark&key={Your_API_Key}`
      </th>
      <td>
        <img
  ...
  <tbody>
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/17/67296/43062.png?apiVersion=1&style=street-light&key={Your_API_Key}`
      </th>
      <td>
        <img
    ...
    <tr>
      <th scope="row">
        ...
        `https://api.Example.com/maps/orbis/map-display/tile/17/67296/43062.png?apiVersion=1&style=street-dark&key={Your_API_Key}`
      </th>
      <td>
        <img
