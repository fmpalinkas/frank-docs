...
Edit the AndroidManifest.xml file and add the service key inside &ltapplication&gt; tag taken from
the [Search API](/search-api/documentation/product-information/introduction) site.
...
<a
  href="#"
  style={{ display: 'block', margin: '0', padding: '0' }}
  name="Search-key-initialization"
></a>

## Key initialization via static method

The following method should be used to pass the API Key to a Geofencing instance.
