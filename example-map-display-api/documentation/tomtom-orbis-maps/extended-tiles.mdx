...
[repo](https://github.com/tomtom-internal/mdapi-extended-tile-converter).  
...
The following query elements are used in calls to generate extended vector tiles. The rest of the path and parameters should be the same as in a regular [tile request](https://developer.tomtom.com/map-display-api/documentation/tomtom-orbis-maps/tile).  
