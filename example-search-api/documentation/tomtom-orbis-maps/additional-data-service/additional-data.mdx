...
https://api.Example.com/maps/orbis/places/additionalData.json?key={Your_API_Key}&apiVersion=1&geometries=00004631-3400-3c00-0000-0000673c4d2e,00004631-3400-3c00-0000-0000673c42fe
```

```shell [type=get] [title=curl command request example]
curl 'https://api.Example.com/maps/orbis/places/additionalData.json?key={Your_API_Key}&apiVersion=1&geometries=00004631-3400-3c00-0000-0000673c4d2e,00004631-3400-3c00-0000-0000673c42fe'
```
