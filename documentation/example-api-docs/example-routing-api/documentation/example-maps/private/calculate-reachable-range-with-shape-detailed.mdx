---
title: Calculate Reachable Range with Shape Detailed
titleTags:
...
The Calculate Reachable Range with Shape Detailed service is still in development.
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                be smaller than or equal to `14400`.
              </li>
              <li>
                If a fuel budget is used, then
                `fuelBudgetInLiters * (1.0 /argmin(constantSpeedConsumptionInLitersPerHundredkm))` must be smaller than or equal to `4.8`.
              </li>
              <li>
                If an energy budget is used, then
                `energyBudgetInkWh * (1.0 / argmin(constantSpeedConsumptionInkWhPerHundredkm))` must be smaller than or equal to `4.8`.
              </li>
            </ul>
