...
https://api.tomtom.com/traffic/map/10/tile/flow/5/4/8.pbf?key={Your_API_Key}
```

<h4 style={{ fontSize: '1em' }}>curl command format</h4>

```shell [type=get] [title=curl command]
curl 'https://api.tomtom.com/traffic/map/10/tile/flow/5/4/8.pbf?key={Your_API_Key}
```
...
https://api.tomtom.com/map/10/tile/flow/17/64989/42178.pbf?key={Your_API_Key}
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         **Internal Server Error** : There is a problem with the TomTom Traffic
